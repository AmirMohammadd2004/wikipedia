...
import com.amir.wikipedia.databinding.FragmentTrendBinding
import com.amir.wikipedia.dataclass.AdapterTrend
import com.amir.wikipedia.dataclass.DataClassTrend
import com.amir.wikipedia.dataclass.Item_Event_Trend
import com.amir.wikipedia.main_activity.MainActivity2
const val  key_intent_Trend = "amirr"

class Fragment_Trend : Fragment() , Item_Event_Trend{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = AdapterTrend(dataTrend, this)
    ...
    override fun item_click_trend(dataClassTrend: DataClassTrend) {

        val intent = Intent(activity,MainActivity2::class.java)
        intent.putExtra(key_intent_Trend,dataClassTrend)
