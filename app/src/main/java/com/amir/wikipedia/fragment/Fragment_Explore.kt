...
import com.amir.wikipedia.adapter.AdapterExplore
import com.amir.wikipedia.adapter.Item_Event
import com.amir.wikipedia.databinding.FragmentExploreBinding
import com.amir.wikipedia.dataclass.DataClassExplore
import com.amir.wikipedia.main_activity.MainActivity2
const val  key_intent_explor = "amir"

class Fragment_Explore : Fragment()   ,  Item_Event{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = AdapterExplore(dataExplore ,this)
        binding.recyclerviewMain.adapter = adapter
        binding.recyclerviewMain.layoutManager = LinearLayoutManager(context,RecyclerView.VERTICAL,false)
    ...
    override fun item_click(dataClassExplore: DataClassExplore) {

        val intent = Intent( activity , MainActivity2 ::class.java)
        intent.putExtra(key_intent_explor, dataClassExplore)
